...
$ stegasis format -alg=lsbp -crypt=aes -pass=password -cap=25 ~/my_video.avi
Formatting video...
Volume size: 30 MB
Format Successful
$ stegasis mount -alg=lsbp -crypt=aes -pass=password ~/my_video.avi /mnt/video
...
ffmpeg -framerate <video_fps> -i /tmp/stegasis/image-%d.jpg -i /tmp/stegasis/audio.mp3 -codec copy -shortest output.mkv
...
The performance of the file system allows full HD video content to be played back from directly within the volume (12 Mb/s). However, achieving read and write speeds in excess of 20 MB/s was not a trivial task. The file system can provide read and write speeds in excess of 30 MB/s (and under ideal conditions\footnote{These conditions are discussed in section \ref{perf}.},  160MB/s.), but only for the algorithms which do not encrypt the embedded data and only if the performance flag has been specified (to stop synchronous flushed to disk). Performance is discussed in more detail in section \ref{perf}.
...
The \texttt{F5} steganographic algorithm, developed by Andreas Westfeld, embeds data within the LSBs of DCT coefficients within \texttt{JPEG}  images. \texttt{F5} implements matrix encoding to improve embedding efficiency and is not vulnerable to the Chi-Squared and Histogram attacks. 

The \texttt{F5} embedding procedure is summarised in Algorithm \ref{algf5}.
...
Raw data: 
Total : 2057, Correct : 1042, Incorrect : 1015
Users: 21
\end{lstlisting}
