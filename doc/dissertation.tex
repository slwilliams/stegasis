...
\begin{center}
	$\textnormal{LSBP}(\mathcal{\textbf{c}},q)(x,y) = \textnormal{LSB}_{q}(\mathcal{\textbf{c}}(x,y))$
\end{center} 
\end{ddef}
...
The extension task ``\texttt{Stegasis} should be evaluated for perceivable video impact using a web application'' will require a web application to be developed and hosted for easy access to participants and a database to store the collected user data. \texttt{Node.js} together with the database \texttt{MongoDB} was chosen as the development stack for the site. This decision was mainly due to the speed at which you can develop \textit{CRUD} (create, read, update and delete) web applications and my previous experience with the technologies.
...
\texttt{LSB} & \texttt{Serpent} & 50 MB & 1.600 $\pm$ 0.02 & 31.24 $\pm$ 0.29   \\ \Cline{2pt}{1-5}
...
\texttt{LSBP} & \texttt{Serpent} & 50 MB & 9.24 $\pm$ 0.33 & 5.41 $\pm$ 0.20   \\ \Cline{2pt}{1-5}
...
\texttt{DCTL} & \texttt{Serpent} & 25 MB & 15.74 $\pm$ 0.01 & 1.59 $\pm$ 0.01   \\ \Cline{2pt}{1-5}
...
\texttt{DCTP} & \texttt{Serpent} & 25 MB & 18.36 $\pm$ 0.05 & 1.36 $\pm$ 0.00   \\ \Cline{2pt}{1-5}
...
\texttt{F4} & \texttt{Serpent} & 1 MB & 18.82 $\pm$ 0.05 & 0.053 $\pm$ 0.00   \\ \Cline{2pt}{1-5}
