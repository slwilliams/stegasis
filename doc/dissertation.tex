...
\begin{tabular}{|c|c|lll}
\cline{1-2}
\textbf{Video file} & \textbf{Format Time (seconds)}       \\ \cline{1-2}
700 MB 10 second \texttt{AVI}& 50    \\ \cline{1-2}
34 MB 4 minute \texttt{MP4} & 100     \\ \cline{1-2}
12 MB 3 minute \texttt{MP4} & 123     \\ \cline{1-2}
80 MB 7 minute \texttt{flv} & 200      \\ \cline{1-2}
\end{tabular}
