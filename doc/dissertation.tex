...
Stegasis combines file systems and stuff.
...
\begin{itemize}
	...
	\item A \textit{Message} is an arbitrary length sequence of symbols. For this project we consider a message $\mathcal{M} \in \{0,1\}^{n} $ for some $n$, that is, a binary string.
