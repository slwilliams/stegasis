...
Secondly, the National Institute of Standards and Technology Statistical Test Suite is applied to the bit string. The results are summarised in Listing \ref{nistres}.
