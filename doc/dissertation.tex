...
To determine that the obtained bit string is in fact random, a number of statistical randomness tests are used.
...
For example figure 1 shows histogram attack using 20\% ... not secure.
