...
\begin{lstlisting}[lanuage=bash,caption={The simple integration test suite (\texttt{test/simple\_integration\_tests.sh}).},frame=single, upquote=true,label=usecase,showstringspaces=false]
#!/bin/bash
