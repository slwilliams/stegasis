...
\noindent
\texttt{Stegasis} therefore has also satisfied all\footnote{I'm considering the audio extension task satisfied since it was investigated and chosen not to be implemented.} of the proposed extension tasks, further cementing the success of the project.

\subsection{Security}
\label{security}

Talk about steganalysis attacks in impl, say resists some. Then talk about evaluation study, then talk about hisogram attack. Then talk about plausable deniabliy as all algirhtms are broken...
