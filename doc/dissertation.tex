...
\begin{lstlisting}[language=C++, caption={The create function call (\texttt{fs/stegfs.cc:202})}, frame=single, label=create]
...
\While{bytes\_written $<$ size}
	...
	\Else
		\State		
		\Comment{Bytes left in frame are not enough for the write call}
		\State		
