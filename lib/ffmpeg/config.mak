...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-gpl --enable-libx264
prefix=/usr/local
...
CC_IDENT=gcc 4.8 (Ubuntu 4.8.2-19ubuntu1)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
CFLAGS=   -std=c99 -fomit-frame-pointer -pthread   -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
...
EXTRALIBS=-lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lxcb-shape -lxcb -lX11 -lx264 -lpthread -lm -ldl -lm -lbz2 -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
libavfilter_VERSION=5.8.101
libavfilter_VERSION_MAJOR=5
libavfilter_VERSION_MINOR=8
libavformat_VERSION=56.19.100
